...
public class MainWindow extends JPanel {
    ...
    public void displayMsg(String texte,String Auteur,int statut){
        ch_Message instanceMsg = new ch_Message(Auteur + " a écrit :\n " + texte,statut);
