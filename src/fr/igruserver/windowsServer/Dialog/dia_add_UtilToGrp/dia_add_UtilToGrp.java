/*
 * Created by JFormDesigner on Thu Jan 09 10:08:52 CET 2020
 */

package fr.igruserver.windowsServer.Dialog.dia_add_UtilToGrp;
 ...
 * @author unknown
 */
public class dia_add_UtilToGrp extends JPanel {
    public dia_add_UtilToGrp() {
        initComponents();
    }
    ...
    private void buttonConfirmActionPerformed(ActionEvent e) {
        String username = textFieldUsername.getText(), grp = textFieldGrp.getText();
        this.setVisible(false);
        this.setEnabled(false);
    }
    ...
    private void initComponents() {
        ...
        //---- label1 ----
        label1.setText("Ajouter Utilisateur \u00e0 un groupe");
